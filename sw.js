...
const CACHE_NAME = 'blue-links-v1.0.0';
const OFFLINE_URL = '/blue-link.html';
...
const PRECACHE_ASSETS = [
  ...
  '/icons/icon-192.png',
  '/icons/icon-512.png',
  // Google Fonts — cache the CSS and the font files
  'https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,500;0,600;1,500&family=DM+Sans:wght@300;400;500;600&family=DM+Mono:wght@400;500&display=swap'
];
